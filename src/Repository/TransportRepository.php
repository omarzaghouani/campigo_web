...
class TransportRepository extends ServiceEntityRepository
{
    ...
    public function countMostPurchasedTransports(): array
    {
        return $this->createQueryBuilder('t')
            ->select('t.num_t, t.cout') // Select num_t and cout columns
            ->groupBy('t.num_t') // Group by num_t to count each transport occurrence
            ->getQuery()
            ->getResult();
    }
